                        ...
                        if bet_data.home_team_score > bet_data.away_team_score:
                            ...
                            if 1.01 < bet_data.previous_home_back_odds < 1.16: # if passed -> place a bet
                                if bet_data.favourite == "home":
                                    if bet_data.draw_back_odds > 2 and bet_data.away_back_odds > 2:
                                        ...
                                        # back
                                        execute_trade_back_lay(driver,bet_data.league,bet_data.sub_table,bet_data.row,"home",stake_ammount,bet_data.home_back_odds,1.01)
                                        # insurance lay
                        ...
                        if bet_data.home_team_score == bet_data.away_team_score:
                            if 1.01 < bet_data.previous_draw_back_odds < 1.16:
                                if bet_data.home_back_odds > 2 and bet_data.away_back_odds > 2:
                                    ...
                                    self.bank_volume = bet_data.previous_bank_volume - stake_ammount
                                    execute_trade_back_lay(driver,bet_data.league,bet_data.sub_table,bet_data.row,"draw",stake_ammount,bet_data.home_back_odds,1.01)
                        ...
                        if bet_data.home_team_score < bet_data.away_team_score:
                            if 1.01 < bet_data.previous_away_back_odds < 1.16:
                                if bet_data.favourite == "away":
                                    if bet_data.home_back_odds > 2 and bet_data.draw_back_odds > 2:
                                        self.market_entry_odds = bet_data.away_back_odds
                                        self.market_entry_type = "away"
                                        self.bank_volume = bet_data.previous_bank_volume - stake_ammount
                                        execute_trade_back_lay(driver,bet_data.league,bet_data.sub_table,bet_data.row,"away",stake_ammount,bet_data.home_back_odds,1.01)
