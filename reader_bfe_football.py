...
class RecordedData:
    def __init__(self, league,sub_table,row,c,driver,strategy,readstates):
        
        self.c = c

        if readstates.get("time_stamp") == "yes":
            try:
        ...
        if readstates.get("game_time_state") == "yes":
            try:
                if sub_table == 0:
        ...
        if readstates.get("home_team_name") == "yes":
            try:      
        ...
        if readstates.get("home_team_score") == "yes":
            try:
        ...
        if readstates.get("away_team_name") == "yes":
            try:
        ...
        if readstates.get("away_team_score") == "yes":
            try: 
        ...
        if readstates.get("total_matched") == "yes":
            try:
        ...
        # count market
        if readstates.get("count_market") == "yes":
            try:
        ...
        # Home back odds ---------------
        if readstates.get("home_back_odds") == "yes":
            try:
        ...
        if readstates.get("previous_home_back_odds") == "yes":
            try:
        ...
        if readstates.get("average_prev_home_back_odds") == "yes":
            try:
        ...
        # Home back volume
        if readstates.get("home_back_volume") == "yes":
            try:
        ...
        # Home lay odds ---------------
        if readstates.get("home_lay_odds") == "yes":
            try:
        ...
        if readstates.get("average_prev_home_lay_odds") == "yes":
            try:
        ...
        # Home lay volume
        if readstates.get("home_lay_volume") == "yes":
            try:
        ...
        # Draw back odds ---------------
        if readstates.get("draw_back_odds") == "yes":
            try:
        ...
        if readstates.get("previous_draw_back_odds") == "yes":
            try:
        ...
        if readstates.get("average_prev_draw_back_odds") == "yes":
            try:
        ...
        # Draw back volume
        if readstates.get("draw_back_volume") == "yes":
            try:
        ...
        # Draw lay odds ---------------
        if readstates.get("draw_lay_odds") == "yes":
            try:
        ...
        # Draw lay volume
        if readstates.get("draw_lay_volume") == "yes":
            try:            
        ...
        # Away back odds ---------------
        if readstates.get("away_back_odds") == "yes":
            try:
        ...
        # previous  Draw back odds 
        if readstates.get("previous_away_back_odds") == "yes":
            try:
        ...
        if readstates.get("average_prev_away_back_odds") == "yes":
            try:
        ...
        # Away back volume
        if readstates.get("away_back_volume") == "yes":
            try:                
        ...
        # Away lay odds ---------------
        if readstates.get("away_lay_odds") == "yes":
            try:
        ...
        if readstates.get("average_prev_away_lay_odds") == "yes":
            try:
        ...
        if readstates.get("favourite") == "yes":
            try:
            ...
            try:
                ...
                self.favourite_odds = 0
        # previous exit odds
        if readstates.get("previous_exit_odds") == "yes":
            try:
        ...
        # previous entry odds
        if readstates.get("previous_entry_odds") == "yes":
            try:
        ...
        # previous entry odds
        if readstates.get("previous_entry_type") == "yes":
            try:
        ...
        if readstates.get("previous_bank_volume") == "yes":
            try:
